...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link" id="v-pills-decorations-tab" data-toggle="pill" href="#v-pills-decorations" role="tab" aria-controls="v-pills-decorations" aria-selected="false">Decorations</a>
    </div>
  </div>
  <div class="col-9">
